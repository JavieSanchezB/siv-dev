...
@section('content')
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{url('circuito/create')}}">Registrar Circuito</a>
            </li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{route('circuito.store')}}" id="formRegistrarGoBlue" role="form" data-toggle="validator" autocomplete="off">
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" id="nombre_circuito" name="nombre_circuito" placeholder=""   required>
