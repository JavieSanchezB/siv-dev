...
@section('content')
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{url('circuito/edit')}}">Registrar Circuito</a>
            </li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{route('actualizar')}}" id="FormBotonActualizar" role="form" data-toggle="validator" autocomplete="off">
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" data-original-title="">
                        <h2><i class="glyphicon glyphicon-star"></i>Ingresar Datos del circuito</h2>
					 ...
					 <!--
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="hidden" class="form-control" id="id" name="id" value="{{ $ids }}"  disabled required>
                    ...
                    <div class="box-content">
                                ...
                                <div class="form-group has-feedback">
									...
									@foreach($circuito as $circuitonombre)
                                    <input type="text" class="form-control" id="nombre_circuito" name="nombre_circuito" placeholder="{{ $circuitonombre->circuito }}"  required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    <div class="help-block with-errors"></div>
									    @endforeach
                                </div></div>
                        ...
                        <button type="submit" form="FormBotonActualizar" class="btn btn-success">ACTUALIZAR</button>
                    </div>
                </div>
            </div>
        </div><!--/row-->
