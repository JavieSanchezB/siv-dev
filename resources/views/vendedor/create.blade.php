...
@section('content')
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{url('vendedor/create')}}">Registrar Vendedor</a>
            </li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{route('vendedor.store')}}" id="formRegistrarGoBlue" role="form" data-toggle="validator" autocomplete="off">
        ...
        <div class="row">
            <div class="box col-md-12">
                <div class="box-inner">
                    <div class="box-header well" data-original-title="">
                        <h2><i class="glyphicon glyphicon-star"></i>Ingresar Datos del Vendedor</h2>
                    ...
                    <div class="box-content">
							 ...
							 <div class="col-lg-3 col-md-4">
                                <div class="form-group has-feedback">
                                    ...
                                    <select class="form-control" name="ruta" id="ruta" data-rel="chosen" data-placeholder="Escoger Ruta">
									    <option></option>
							...
							<div class="col-lg-3 col-md-4">
                                <div class="form-group has-feedback">
                                    ...
                                    <select class="form-control" name="supervisor" id="supervisor" data-rel="chosen" data-placeholder="Escoger Supervisor">
									    <option></option>
