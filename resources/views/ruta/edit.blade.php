...
@section('content')
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{url('ruta/create')}}">Registrar Cliente</a>
            </li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{route('actualizarruta')}}" id="formRegistrarGoBlue" role="form" data-toggle="validator" autocomplete="off">
                    ...
                    <div class="box-content">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" id="nombre_ruta" name="nombre_ruta"  placeholder="{{ $rutanombre->nombre_ruta}}"   required>
                        ...
                        <button type="submit" form="formRegistrarGoBlue" class="btn btn-success">Actualizar</button>
                    </div>
                </div>
            </div>
        </div><!--/row-->
