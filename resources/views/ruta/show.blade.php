...
@section('content')
    ...
    <form method="POST" action="{{route('ruta.asignarruta')}}" id="formRegistrarGoBlue" role="form" data-toggle="validator" autocomplete="off">
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <select class="form-control" name="nombre_ruta" id="nombre_ruta" data-rel="chosen" data-placeholder="Escoger Circuito">
										 <option></option>
